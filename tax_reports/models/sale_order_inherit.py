...
class InvoiceInherit(models.Model):
    ...
    l10n_sa_confirmation_datetime = fields.Datetime(string='Confirmation Date',default=fields.Datetime.now ,readonly=True, copy=False)
    ...
    def _get_tax_report_base_filename(self):
        ...
        self.ensure_one()
        return "%s - %s - %s" % (
        self.company_id.vat, "{:%Y-%m-%d %H_%M_%S}".format(self.create_date.now() + timedelta(hours=3)),
